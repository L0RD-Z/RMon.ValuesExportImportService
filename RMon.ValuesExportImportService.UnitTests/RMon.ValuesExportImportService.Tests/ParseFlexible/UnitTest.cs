...
namespace RMon.ValuesExportImportService.Tests.ParseFlexible
{
    ...
    public class UnitTest
    {
        ...
        public async Task Test1()
        {
            ...
            var tagsRepository = new TagsRepositoryStub(idLogicDevices);
            ...
            var logic = new ParseFlexibleLogic(logicDeviceRepository, tagsRepository, _permissionLogic, _excelWorker);
            try
            {
                ...
                Assert.AreEqual(59, values.Select(t => t.IdTag).Distinct().Count(), "Количество тегов не совпадает");
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
