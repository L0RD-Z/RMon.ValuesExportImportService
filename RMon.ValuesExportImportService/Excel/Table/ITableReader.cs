...
namespace RMon.ValuesExportImportService.Excel.Table
{
    internal interface ITableReader
    {
        ...
        /// </summary>
        /// <param name="file">Книга Excel</param>
        ...
        /// <returns></returns>
        List<ExcelLogicDeviceValues> ReadExcelBook(LocalFile file, int logicDevicePropertyValueRowIndex, ExcelCellAddress cellStart, int dateColumnIndex, int timeColumnIndex, ParseProcessingContext context);
    }
}