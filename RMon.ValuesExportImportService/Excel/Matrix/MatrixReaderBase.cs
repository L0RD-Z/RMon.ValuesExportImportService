...
namespace RMon.ValuesExportImportService.Excel.Matrix
{
    abstract class MatrixReaderBase : IMatrixReader
    {
        ...
        /// <inheritdoc />
        public List<ExcelLogicDeviceValues> ReadExcelBook(LocalFile file, ExcelCellAddress logicDevicePropertyValueCell, ExcelCellAddress cellStart, int dateColumnIndex, int timeColumnIndex, ParseProcessingContext context)
        {
